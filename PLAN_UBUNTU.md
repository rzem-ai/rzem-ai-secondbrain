...
cd /path/to/second-brain/skills/vetted/youtube-direct
npm install
...
> **Security Review**: Both options have been vetted. See `skills/SKILL_COMPARISON.md` for detailed comparison.
...
| Third-party skill data exposure | Low-Medium | Medium | **✅ MITIGATED**: Prefer youtube-direct (no third-party). TranscriptAPI vetted as alternative. |
